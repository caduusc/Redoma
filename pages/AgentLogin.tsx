    ...
    <div className="min-h-screen bg-redoma-light flex flex-col items-center justify-center p-6">
      <div className="w-full max-w-md bg-white rounded-[2rem] shadow-2xl shadow-redoma-dark/5 overflow-hidden border border-slate-100">
        <div className="p-10 border-b border-slate-50 text-center bg-slate-50/30">
          ...
          <p className="text-slate-400 text-[10px] mt-1 font-extrabold uppercase tracking-[0.2em]">Painel do Atendente</p>
        </div>
        ...
        <form onSubmit={handleLogin} className="p-10 space-y-6">
          ...
          <button
            type="submit"
            className="w-full bg-redoma-dark text-white font-bold py-4 rounded-2xl hover:bg-redoma-navy transition-all shadow-xl active:scale-[0.98] uppercase tracking-widest text-xs"
          >
            Acessar Sistema
          </button>
        </form>
