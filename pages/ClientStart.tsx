    ...
    <div className="p-6 space-y-5 pt-4">
      <div className="flex items-start justify-between gap-4">
        ...
        <button
          ...
          className="shrink-0 rounded-xl border border-redoma-dark bg-transparent px-3 py-1.5 text-[11px] font-bold uppercase tracking-[0.18em] text-redoma-dark hover:bg-redoma-dark/5 transition"
        >
          Como usar
        </button>
      </div>
